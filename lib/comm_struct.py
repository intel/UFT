...
from comm_struct_version import *
...
rte_flow_action_ethdev = collections.namedtuple('rte_flow_action_ethdev', ['port_id'])
rte_flow_action_ethdev.__new__.__defaults__ = (0,)
